...
@synthesize notebooksArray,managedObjectContext;
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        Tiny4NoteAppDelegate* app = (Tiny4NoteAppDelegate*)[[UIApplication sharedApplication] delegate];
...
- (void)viewDidLoad
{
    ...
    self.notebooksArray = mutableFetchResults;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[notebooksArray objectAtIndex:indexPath.row] name];
    return cell;
}
